...
def execute():
    try:
        ...
        return Response(data={"success": True, "message": "Task status retrieved", "task_id": task_id, "status": "running"}, metadata={"task_id": task_id})
        ...
        # else:
        #     return Response.error(f"Failed to get task status: {status_response.text}")
