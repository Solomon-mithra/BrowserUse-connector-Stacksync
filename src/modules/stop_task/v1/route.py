...
def stop_task(access_token: str, task_id: str):
...
def execute():
    """
    Stop a running browser automation task immediately. Expects 'api_connection' and 'task_id' in the request body.
    """
    try:
        ...
        result = stop_task(access_token=access_token, task_id=task_id)
