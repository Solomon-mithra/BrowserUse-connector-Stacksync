...
def get_task_screenshots(access_token: str, task_id: str):
    url = f"https://api.browser-use.com/api/v1/task/{task_id}/screenshots"
    headers = {
...
def execute():
    ...
    try:
        ...
        result = get_task_screenshots(access_token=access_token, task_id=task_id)
